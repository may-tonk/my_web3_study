...
contract DutchAuction is Ownable, ERC721 {
    ...
    uint256 public constant COLLECTION_SIZE = 2 ;// NFT总数
    uint256 public constant AUCTION_START_PRICE = 0.1 ether; // 起拍价
    uint256 public constant AUCTION_END_PRICE = 0.01 ether; // 结束价（最低价）
